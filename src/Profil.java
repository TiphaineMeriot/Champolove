...
public class Profil implements Comparable<Profil>{
    ...
    public String toString(){
        ...
        public static void main (String[]args) throws ParseException {
            ...
            Profil DylanPaquie010803=new Profil("IeqPa", "Nalyd",Genre.HOMME.name(), "01/02/2003", Statut.CELIBATAIRE.name(),"Albi",Genre.FEMME.name());
            System.out.println(DylanPaquie010803);
        }
