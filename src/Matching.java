...
public class Matching{
    ...
    public static void matching1(Profil p1,double tailleminimale,int distancemax,ArrayList<String> recherchequal
...
;//Je trie le tree (c'est trop marrant)
        //plus sérieusement ça sert à avoir l'ensemble avec les plus compatibles en premier.
        ...
        for(Profil profil:rechercher){
            if(profil.recherche.equals(p1.genre) && profil.taille>=tailleminimale && p1.compareTo(profil)<= distancemax){
    ...
    public static void main(String[] args) throws Exception {
        ...
        matching1(p1,1,30000,S_qual,S_def,S_hob);
